...
You have two options here. You can fork the [Corpora repo directly](https://github.com/dariusk/corpora) or you can choose to fork the ["Open Source Studio" fork of Corpora](https://github.com/Open-Source-Studio-at-ITP/corpora). [Instructions for how to fork are on the GitHub guide](https://guides.github.com/activities/forking/).
